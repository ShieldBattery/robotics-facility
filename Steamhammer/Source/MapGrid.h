...
public:
    ...
    BWAPI::Position		getLeastExplored(bool byGround, int mapPartition, BWAPI::Unit sampleUnit = nullptr);
    BWAPI::Position     getLeastExploredNear(const BWAPI::Position & center, bool byGround, bool safe = false);
    BWAPI::Position     getLeastExploredNearBase(Base * center, bool byGround, bool safe = false);
	...
	int lastSeenFrame(const BWAPI::Position & pos);

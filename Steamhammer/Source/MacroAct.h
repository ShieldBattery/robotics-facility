...
enum class MacroLocation
    ...
    , Tile         // at or near a specific tile
    };
...
class MacroAct 
{
    ...
    BWAPI::TilePosition _tileLocation;      // only set when _macroLocation is Tile
...
public:
	...
	std::vector<BWAPI::Unit> getCandidateProducers() const;

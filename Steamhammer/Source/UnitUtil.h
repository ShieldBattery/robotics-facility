...
namespace UnitUtil
{
	...
	bool IsMorphedType(BWAPI::UnitType type);
	...
	bool IsValidEnemyUnit(BWAPI::Unit unit);

	bool BuildingIsBusy(BWAPI::Unit unit);
	...
	int GetMyAttackRange(BWAPI::UnitType attacker, BWAPI::UnitType target);
	int GetYourAttackRange(BWAPI::UnitType attacker, BWAPI::UnitType target);
	int GetMaxAttackRange(BWAPI::UnitType attacker, BWAPI::UnitType target);
	...
	bool FriendlyDetectorInRange(BWAPI::Position pos);

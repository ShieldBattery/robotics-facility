...
class StrategyBossZerg
{
    ...
    bool queueSupplyIsOK(BuildOrderQueue & queue) const;
    ...
    void setAvailableTechUnits(std::array<bool, int(TechUnit::Size)> & available) const;
    ...
    void produceOtherStuff(int & mineralsLeft, int & gasLeft);
	void produceAnything();

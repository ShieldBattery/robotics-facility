...
namespace UAlbertaBot {
    ...
    class FastAPproximation {
        struct FAPUnit {
            ...
            mutable int groundCooldown = 0;					// in frames
            ...
            mutable int airCooldown = 0;					// in frames
        ...
        private:
            ...
            // A squared distance greater than the largest squared distance that FAP will use.

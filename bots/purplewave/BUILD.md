...
Install an x64 Java 21 JDK, Node 24.12+, pnpm, and Git. Fetch the exact sources with
`pnpm sources`, then run `node tools/build-purplewave.ts purplewave-sb-2 <java-home>`.
...
Use `node tools/package-purplewave.ts .build/purplewave-sb-2 purplewave-sb-2 --review`
